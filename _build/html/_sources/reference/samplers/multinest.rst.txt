...
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| feedback               | bool    | T         | Print out progression information from multinest                                                                                                     |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| multinest_outfile_root | str     | (empty)   | In addition to CosmoSIS output, save a collection of multinest output files                                                                          |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| resume                 | bool    | F         | If you previously set multinest_outfile_root you can restart an interrupted chain with this setting                                                  |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| update_interval        | integer | 200       | Frequency of printed output from inside multinest                                                                                                    |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| random_seed            | integer | -1        | Seed to use for random proposal; -1 to generate from current time.  Allows re-running chains exactly                                                 |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| ins                    | boolean | True      | Use Importance Nested Sampling (INS) mode - see papers for more info                                                                                 |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| constant_efficiency    | bool    | N         | Constant efficiency mode - see papers                                                                                                                |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| efficiency             | float   | 0.1       | Target efficiency for INS - see papers                                                                                                               |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| log_zero               | float   | -1e5      | Log-probabilities lower than this value are considered to be -infinity                                                                               |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| tolerance              | float   | 0.1       | Target error on evidence                                                                                                                             |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| mode_separation        | bool    | N         | Optimize for multi-modal or other odd likelihoods - split into different proposal modes                                                              |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| max_modes              | integer | 100       | If multi-modal, maximum number of allowed modes                                                                                                      |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| cluster_dimensions     | integer | -1        | Look for multiple modes only on the first dimensions                                                                                                 |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| mode_ztolerance        | float   | 0.5       | If multi-modal, get separate stats for modes with this evidence difference                                                                           |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| wrapped_params         | str     | (empty)   | Space separated list of parameters (section--name) that should be given periodic boundary conditions. Can help sample params that hit edge of prior. |
+------------------------+---------+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
