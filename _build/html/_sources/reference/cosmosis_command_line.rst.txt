...
CosmoSIS can generate a graphical representation of your pipeline showing how data flows between modules using the :code:`--graph` option. For detailed information about making pipeline graphs, see :doc:`../features/pipeline_features`.
